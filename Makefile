...
RENDER_SRC = render/render_core.c render/render_core_2.c render/render_weapons.c render/render_floor.c render/render_weapon_pickups.c
...
DOOR_SRC = door/door_core.c door/door_render.c door/door_render_2.c door/door_textures.c door/door_textures_2.c door/door_sprites.c door/door_utils.c
