...
PLAYER_SRC = player/player_move.c player/movement/player_movement.c player/movement/player_rotation.c player/input/player_keyboard.c player/input/player_weapon_switch.c player/input/player_mouse.c player/pickup/player_pickup.c player/pickup/player_pickup_healgun.c player/utils/player_utils.c
...
SHOOT_SRC = shoot/shoot_core.c shoot/shoot_portal.c shoot/shoot_raygun.c shoot/shoot_utils.c shoot/shoot_portal_utils.c
